...
export default function Character() {
  ...
  const [characters, updateCharacters] = useState([
    ...
    { type: "Fire", skin: 1, unlocked: false, power: 5, speed: 3, health: 1, two: false, three: false, id: 2 },
    { type: "Ice", skin: 1, unlocked: false, power: 4, speed: 2, health: 3, two: false, three: false, id: 3 },
    { type: "Earth", skin: 1, unlocked: false, power: 4, speed: 1, health: 4, two: false, three: false, id: 4 },
    { type: "Air", skin: 1, unlocked: false, power: 3, speed: 5, health: 1, two: false, three: false, id: 5 },
    { type: "Electric", skin: 1, unlocked: false, power: 3, speed: 4, health: 2, two: false, three: false, id: 6 },
    { type: "Honey", skin: 1, unlocked: false, power: 3, speed: 2, health: 4, two: false, three: false, id: 7 },
    { type: "Poison", skin: 1, unlocked: false, power: 5, speed: 2, health: 2, two: false, three: false, id: 8 },
    { type: "Wild", skin: 1, unlocked: false, power: 4, speed: 3, health: 2, two: false, three: false, id: 9 },
    { type: "Shadow", skin: 1, unlocked: false, power: 3, speed: 4, health: 2, two: false, three: false, id: 10 },
    { type: "BubbleGum", skin: 1, unlocked: false, power: 2, speed: 2, health: 5, two: false, three: false, id: 11 },
    { type: "Armored", skin: 1, unlocked: false, power: 3, speed: 1, health: 5, two: false, three: false, id: 12 },
    { type: "Celestial", skin: 1, unlocked: false, power: 4, speed: 4, health: 1, two: false, three: false, id: 13 },
